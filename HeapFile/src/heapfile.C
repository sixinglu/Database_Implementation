...
//        }
        ...
        do{
            ...
            if( dirinfo.availspace > recLen){  // avaiable space, read out the real record page
                ...
                dirinfo.availspace = dirinfo.availspace - recLen;    // reduce the space
        ...
        if(successFlag==true){
        ...
        else if(currdir->available_space()>sizeof(DataPageInfo)){   // but still have slot in this dir page, create a new page for record, and
            ...
            newdpinfop.availspace = MINIBASE_PAGESIZE-recLen;
            newdpinfop.recct = 1;
